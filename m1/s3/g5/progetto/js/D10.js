...
/*SO CHE NON ERANO NECESSARI I PARAMETRI MA HO PREFERITO FARE UNA FUNZIONE GENERICA PER ESSERE SICURO CHE FUNZIONASSE CORRETTAMENTE*/
...
console.log(deleteOne("castoro", false));
...
console.log(onlyLetters("ho 27 anni e 98 giorni"));
...
console.log(isThisAnEmail("ciao@antonio.it"));
...
function rollTheDices(n) {
  ...
  for (let i = 0; i < n; i++) {
    let estrazione = dice(1, 6);
    risultato.sum += estrazione;
    risultato.values.push(estrazione);
  }
  return risultato;
}
...
function howManyDays(data) {
  ...
  return Math.floor((dataOggi - data) / 1000 / 60 / 60 / 24);
}
console.log(howManyDays(new Date("Fri,Oct,10 2023")));
...
console.log(isTodayMyBirthday(new Date("Fri,Oct,13 2023")));
// Arrays & Oggetti
